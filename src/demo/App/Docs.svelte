...
<script>
  ...
  // Installation docs
  const installDocs = `$ yarn add https://github.com/reuters-graphics/chart-module-parliament-chart.git`;

  // JavaScript docs
  $: jsDocs = `import Chart from '@reuters-graphics/parliament-chart';
...
`;
  ...
  // SCSS docs
  const styleDocs = `$ParliamentChart-container: '.parliament-chart-container';
...
<div class='repo-link'>
  <a href="https://github.com/reuters-graphics/chart-module-parliament-chart" target="_blank">
    <Icon icon={faGithub} />
  </a>
</div>
